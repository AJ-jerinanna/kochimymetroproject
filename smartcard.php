                ...
                <div class="col-md-5">
                    <div class="row">
                      <div class="col-md-12 form-group">
                            ...
                            <input type="text" id="cname" class="form-control form-control-lg" name="cname" pattern="[A-Z a-z]{1,}" title="Use Characters only " autocomplete="off">
                        </div>
                      <div class="col-md-12 form-group">
                            <label for="username">Phone</label>
                            <input type="text" id="username" class="form-control form-control-lg" name="phn">
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="username">DOB</label>
                            <input type="date" id="username" class="form-control form-control-lg" name="dob" min="1970-01-01" max="2001-01-01">
                        </div>
                        <div class="col-md-12 form-group">
                        ...
                        <div class="col-md-12 form-group">
                            ...
                            <input type="text" id="occ" class="form-control form-control-lg" name="occ">
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="pword">House name</label>
                            <input type="text" id="pwd" class="form-control form-control-lg" name="hname">
                        </div>
                        <div class="col-md-6">
                            
                        <label for="">District</label>
                      
                        <select name="dis" id="" class="form-control form-control-lg">
                          <option value="" >...Select...</option>
          <?php
          while($fetch=mysqli_fetch_array($db2))
          {
            ...
            ?>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="text" id="pwd" class="form-control form-control-lg" name="city">
                        </div>
                        <div class="col-md-12 form-group">
                            <label for="pword">Pin code</label>
                            <input type="text" id="pwd" class="form-control form-control-lg" name="pincode">
                        </div>

                        <div class=col-md-12 form-group">
                            <label for="pword">National Id Type</label>
                            <select name="ntype" id="" class="form-control form-control-lg">
                          <option value="">Select</option>
                        ...
                        <div class="col-md-12 form-group">
                            <label for="pword">National Id no</label>
                            <input type="text" id="pwd" class="form-control form-control-lg" name="typeno">
                        </div>
...
include 'co.php';
    ...
    $sql="INSERT INTO cardreg(name,phone,dob,gender,occupation,housename,disid,city,pincode,ntype,nno)VALUES('$a','$b','$c','$d','$e','$f','$g','$h','$i','$j','$k')";
